...
class FieldGraphicsScene(QGraphicsScene):
    """this class provides a scene to manage all the items in the field """
    ...
    def harvest_crop(self,crop_to_harvest):
        ...
        self.field.harvest_crop(position) #remove crop
    ...
    def _add_graphic_item(self,result,graphic_item_type):
        if result:
            ...
            error_message.setText("No more {0}s can be added o this field".format(graphic_item_type))
            error_message.exec()
    ...
    def dropEvent(self,event):
        ...
        #what to do if an object is dropped on to the scene
